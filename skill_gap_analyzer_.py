# -*- coding: utf-8 -*-
"""Skill Gap Analyzer .ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1KNtAPdAE1spQfYaBecCKrLNLY8_vWJMj
"""
...
!pip install numpy
!pip install torch
!pip install ngrok   # Optional: if you're tunneling Streamlit via ngrok
!pip uninstall -y fitz  # Remove broken package
!pip install -q PyMuPDF  # Install correct one
...
# Step 3: Start Streamlit app in the background
!streamlit run app.py &>/content/log.txt &

# Step 4: Expose via ngrok
from pyngrok import ngrok, conf

conf.get_default().auth_token = "2xfGYHAi8G0bP2m5sDNYK4DoLEn_2XEk6UgSztCRPbt3C6d8C"  # <- Replace this with your token
